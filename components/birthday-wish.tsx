...
export default function BirthdayWish() {
  ...
  return (
    // Main container
    <div className="min-h-screen bg-gradient-to-t from-pink-400 to-sky-400 flex items-center justify-center p-4">
      ...
      >
        ...
        <Card className="mx-auto overflow-hidden transition-all duration-300 ease-in-out hover:shadow-xl border-2 border-black">
          ...
          <CardHeader className="text-center">
            ...
            <CardDescription className="text-2xl font-semibold text-orange-500">Bushra Arshad</CardDescription>
            <p className="text-lg text-gray-900">january 14th</p>
          </CardHeader>
